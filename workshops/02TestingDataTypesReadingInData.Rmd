...
![R](../pics/R.png) Read the data in to R by using the `read_table()` command:
```{r eval=FALSE}
...
![R](../pics/R.png) To read the data in to R you need to use the relative path to the file in the `read_table()` command:
