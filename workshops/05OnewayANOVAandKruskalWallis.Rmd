...
![W](../pics/W.png) Compare [seal.csv](../data/seal.txt) and [adipocytes.txt](../data/adipocytes.txt) by opening the file. You can do this in RStudio by clicking on the files in the files window.
...
This figure is good .... but it would be nice to show the result of the post-hoc host by annotating the figure. 
...
This figure is good but it would be nice to show the result of the post-hoc host by annotating the figure. Again, ggplot makes this fairly easy.
