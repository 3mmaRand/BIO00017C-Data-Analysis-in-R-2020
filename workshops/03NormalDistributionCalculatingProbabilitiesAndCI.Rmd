...
![R](../pics/R.png) Make an RStudio project for this workshop by clicking on the drop-down menu on top right where it says [Project: (None)](../pics/new-project.png) and choosing New Project and then New Directory. Navigate to the "data-analysis-in-r" folder. Name the RStudio Project 'workshop3.
...
![R](../pics/R.png) First, create variables for the parameter values - this is considered good practice.
...
![R](../pics/R.png) Look at the manual page. Because the default is lower.tail = TRUE, we get the probability we want, P[IQ \< 115]
...
![Q](../pics/Q.png)Is this what you expect? <!-- #---THINKING ANSWER--- --> <!-- # You should expect this if you remember from the lecture that about 68% of the values are between - 1 s.d. and + 1 s.d and that 15 is the s.d. in this case -->

![R](../pics/R.png) What is 1.96 $\times$ standard deviation?
...
![R](../pics/R.png) Rename the column to 'wing'
...
![R](../pics/R.png) To calculate the 95% confidence interval we need to look up quantile (multiplier) using `qnorm()`
...
![R](../pics/R.png) We can assign this to a variable using:
...
![R](../pics/R.png) And the confidence interval by:
